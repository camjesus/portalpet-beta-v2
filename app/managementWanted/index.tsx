...
export default function ManagementWanted() {
  ...
  return (
    <ViewCustom>
      ...
      <FinishedView
        title="¡Eureka! 🎉"
        description={`¡Qué alegría que la reencontraste! Sabemos lo que significa tenerla en casa. \n¡Gracias por confiar en Portal Pet!`}
      />
      ) : (
        <>
      <HeaderCustom
      ...
      <FlatList
        ...
        ListEmptyComponent={
        <EmptyContacts
        title="Nadie se contactó aún"
        description="Cuando alguien vea a tu mascota y se contacte, aparecerá aquí."
        />
        }
      />
      ...
      <ConfirmModal
        visible={showConfirm}
        title="🎉 ¡Eureka!"
        description="¡Encontraste a tu mascota! Nos alegramos muchísimo. Gracias por confiar en Portal Pet."
